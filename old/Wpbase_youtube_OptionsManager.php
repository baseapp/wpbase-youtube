...
class Wpbase_youtube_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'wpbase_youtube'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'wpbase_youtube'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'wpbase_youtube'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'wpbase_youtube'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'wpbase_youtube');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'wpbase_youtube'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'wpbase_youtube');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'wpbase_youtube'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'wpbase_youtube') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'wpbase_youtube');
            case 'false':
                return __('false', 'wpbase_youtube');

            case 'Administrator':
                return __('Administrator', 'wpbase_youtube');
            case 'Editor':
                return __('Editor', 'wpbase_youtube');
            case 'Author':
                return __('Author', 'wpbase_youtube');
            case 'Contributor':
                return __('Contributor', 'wpbase_youtube');
            case 'Subscriber':
                return __('Subscriber', 'wpbase_youtube');
            case 'Anyone':
                return __('Anyone', 'wpbase_youtube');
        }
        return $optionValue;
    }
